...
if exists("b:is_bash")
 ...
 syn keyword bashStatement complete
 syn keyword bashAdminStatement daemon killall killproc reload restart start status stop
endif
...
if exists("b:is_kornshell")
 ...
 syn keyword kshStatement killall
endif
